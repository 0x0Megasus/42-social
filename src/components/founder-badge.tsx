...
export function FounderBadge({ className = "" }: { className?: string }) {
  return (
    ...
    >
      ...
      <span
        role="tooltip"
        className="pointer-events-none absolute left-1/2 top-full z-50 mt-1.5 hidden w-max max-w-[12rem] -translate-x-1/2 rounded-lg bg-zinc-900 px-2.5 py-1.5 text-center shadow-xl group-hover:block"
      >
